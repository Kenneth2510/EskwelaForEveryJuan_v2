...
export default function EditRole() {
    ...
    const changeCategory = (cat: UserCategory) => {
        setCategory(cat);
        form.setData('category', cat); // <-- update form data
    };
                ...
                <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl dark:text-gray-100">Edit Role</h1>
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Update role details and permissions</p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        <button
                                            type="button"
                                            onClick={() => changeCategory('learner')}
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => changeCategory('instructor')}
                                            className={`flex items-center justify-center gap-2 rounded-lg border px-3 py-2 text-sm font-semibold ${
                                                category === 'instructor'
                                                    ? 'border-red-800 bg-red-800 text-white'
                                                    : 'border-gray-200 bg-white text-gray-700 dark:bg-gray-700 dark:text-gray-200'

...
export default function CreateLearner() {
    ...
    const handleUserSubmit = (e: React.FormEvent) => {
        ...
        MySwal.fire({
            title: <p className="text-gray-900 dark:text-gray-100">Creating Student...</p>,
                ...
                <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-100">Add New Student</h1>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="mt-3 text-xs text-blue-600 dark:text-blue-400">
                                                The student will receive their login credentials via email after account creation.
                                            </p>
                                        </div>
                                    </div>
                                </div>

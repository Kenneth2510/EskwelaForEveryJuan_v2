...
export default function DeleteLearner({ learner }) {
    const handleDelete = () => {
        Swal.fire({
            title: 'Are you sure?',
            text: 'This action cannot be undone. The student record will be permanently deleted.',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                router.delete(route('learner.destroy', learner), {
                    onSuccess: () => {
                        Swal.fire({
                            title: 'Deleted!',

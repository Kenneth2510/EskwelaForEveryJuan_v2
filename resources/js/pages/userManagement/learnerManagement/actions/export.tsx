...
export default function ExportLearner({ searchVal = "", sorting = [], onExport }: ExportProps) {
  ...
  const pickExportType = async (type: "pdf" | "csv" | "xlsx") => {
    ...
    try {
      const response = await axios.post("/user-management/learner/export", payload, {
        responseType: "blob",

...
export default function BulkUpload({ templateUrl }: PageProps) {
    ...
    async function handlePreview(e: React.FormEvent) {
        ...
        try {
            // <- backend expects /user-management/admin/bulk/upload
            const { data } = await axios.post('/user-management/admin/bulk/upload', form, {
    ...
    async function handleCommit() {
        ...
        const { isConfirmed } = await MySwal.fire({
            title: `Insert ${toInsert.length} admins?`,
            text: 'This will create user and admin records for each selected row.',
            icon: 'question',
        ...
        setCommitting(true);
        try {
            const { data } = await axios.post('/user-management/admin/bulk/insert', { rows: toInsert });
            ...
            // Redirect back to admins list (use simple navigation so we don't require @inertiajs/inertia)
    ...
    return (
        <AppLayout
            breadcrumbs={[
                { title: 'Admin Management', href: '/user-management/admin' },
                { title: 'Bulk Insert', href: '/user-management/admin/bulk' },
            ]}
        >
            <Head title="Bulk Insert — Admin Management" />
                ...
                <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Bulk Insert Admin</h1>
                        ...
                        <Button asChild variant="outline" className="border-gray-200 dark:border-gray-700">
                            <Link href="/user-management/admin" className="flex items-center gap-2">
                    ...
                    <div className="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                            <div className="space-y-1">
                                ...
                                <a
                                    href={templateUrl ?? '/templates/AdminManagementBulkInsertTemplate.xlsx'}
                                        ...
                                        {rows.map((r, i) => {
                                            ...
                                            return (
                                                <TableRow key={i} className={hasErrors ? 'bg-red-50/50 dark:bg-red-950/10' : ''}>
                                                    ...
                                                    <TableCell className="font-mono">{r.admin_code ?? '—'}</TableCell>
